...
function SentimentComponent({
    ...
    function draw(id_to_draw) {
        ...
        sentiment.append("img")
            .each(appear)
            .attr("src", d=>`https://raw.githubusercontent.com/com-480-data-visualization/datavis-project-2022-independentua/main/pictures/world_reactions/sentiment_${d.sentiment}.png`)
            .style("width", "60px")
            .style("height", "60px")
            .style("margin", "10px");
        sentiment.append("p")
        ...
        emotion.append("img")
            .each(appear)
            .attr("src", d=>`https://raw.githubusercontent.com/com-480-data-visualization/datavis-project-2022-independentua/main/pictures/world_reactions/emotion_${d.emotion}.png`)
            .attr("width", "60px")
            .style("height", "60px")
            .style("margin", "10px");
        emotion.append("p")
